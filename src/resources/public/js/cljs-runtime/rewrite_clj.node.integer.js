...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k45972,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45972,else__5346__auto__);
...
var vec__46003 = p__45998;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46003,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46003,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45971){
var self__ = this;
var G__45971__$1 = this;
return (new cljs.core.RecordIter((0),G__45971__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45973,other45974){
var self__ = this;
var this45973__$1 = this;
return (((!((other45974 == null)))) && ((((this45973__$1.constructor === other45974.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45973__$1.value,other45974.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45973__$1.base,other45974.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45973__$1.__extmap,other45974.__extmap)))))))));
}));
...
var abs_value = (function (){var G__46055 = self__.value;
if((self__.value < (0))){
return (- G__46055);
} else {
return G__46055;
...
var prefix = (function (){var G__46056 = cljs.core.long$(self__.base);
switch (G__46056) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k45972){
var self__ = this;
var this__5350__auto____$1 = this;
var G__46063 = k45972;
var G__46063__$1 = (((G__46063 instanceof cljs.core.Keyword))?G__46063.fqn:null);
switch (G__46063__$1) {
case "value":
case "base":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45972);

}
}));

(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__45971){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__46066 = cljs.core.keyword_identical_QMARK_;
var expr__46067 = k__5352__auto__;
if(cljs.core.truth_((pred__46066.cljs$core$IFn$_invoke$arity$2 ? pred__46066.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__46067) : pred__46066.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__46067)))){
return (new rewrite_clj.node.integer.IntNode(G__45971,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46066.cljs$core$IFn$_invoke$arity$2 ? pred__46066.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__46067) : pred__46066.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__46067)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__45971,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__45971),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__45971){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__45971,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__45977){
var extmap__5385__auto__ = (function (){var G__46085 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45977,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__45977)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46085);
} else {
return G__46085;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__45977),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__45977),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
