...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__45730_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__45730_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__45730_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__45731){
var vec__45732 = p__45731;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45732,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45732,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__45738,s,color,element,idx){
var map__45739 = p__45738;
var map__45739__$1 = cljs.core.__destructure_map(map__45739);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45739__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45739__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45739__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__45746 = (function (){var or__5045__auto__ = color;
...
var fexpr__45745 = (function (){var G__45747 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__45747) : style_map.call(null,G__45747));
})();
return (fexpr__45745.cljs$core$IFn$_invoke$arity$1 ? fexpr__45745.cljs$core$IFn$_invoke$arity$1(G__45746) : fexpr__45745.call(null,G__45746));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__45748){
var vec__45749 = p__45748;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45749,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45749,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45749,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__45752){
var vec__45753 = p__45752;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45753,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45753,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45753,(2),null);
...
var G__45868 = cljs.core.next(ssv);
var G__45869 = (this_ssv == null);
var G__45870 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__45871 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__45868;
doing_nil_QMARK_ = G__45869;
last_elide = G__45870;
out = G__45871;
continue;
}
...
var vec__45770 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45770,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45770,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45770,(2),null);
...
var G__45872 = cljs.core.next(remaining_cvec);
var G__45873 = new_idx;
var G__45874 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__45872;
idx = G__45873;
out = G__45874;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__45795,cursor_vec){
var vec__45796 = p__45795;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45796,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45796,(1),null);
var focus_vec = vec__45796;
...
var vec__45799 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45799,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45799,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__45809){
var vec__45810 = p__45809;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45810,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45810,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__45828,existing_count){
var vec__45829 = p__45828;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45829,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45829,(1),null);
...
return cljs.core.filterv((function (p1__45821_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__45821_SHARP_))));
...
var vec__45841 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45841,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45841,(1),null);
var cvec_element = vec__45841;
if((cvec_element == null)){
var G__45888 = cljs.core.next(cvec_nl);
var G__45889 = (idx + (1));
var G__45890 = start;
var G__45891 = out;
cvec_nl = G__45888;
...
var G__45893 = cljs.core.next(cvec_nl);
var G__45894 = (idx + (1));
var G__45895 = idx;
var G__45896 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__45893;
idx = G__45894;
start = G__45895;
out = G__45896;
...
var G__45898 = cljs.core.next(cvec_nl);
var G__45899 = (idx + (1));
var G__45900 = (idx + (1));
var G__45901 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__45898;
idx = G__45899;
start = G__45900;
out = G__45901;
...
var G__45902 = cljs.core.next(cvec_nl);
var G__45903 = (idx + (1));
var G__45904 = idx;
var G__45905 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__45902;
idx = G__45903;
start = G__45904;
out = G__45905;
...
var G__45906 = cljs.core.next(cvec_nl);
var G__45907 = (idx + (1));
var G__45908 = start;
var G__45909 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__45906;
idx = G__45907;
start = G__45908;
out = G__45909;
...
if(zprint.finish.within_QMARK_(idx,p2__45848_SHARP_)){
return cljs.core.reduced(p1__45849_SHARP_);
} else {
return (p1__45849_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__45850,p__45851){
var vec__45852 = p__45850;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45852,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45852,(1),null);
var vec__45855 = p__45851;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45855,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45855,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__45859,cvec,focus_vec){
var map__45860 = p__45859;
var map__45860__$1 = cljs.core.__destructure_map(map__45860);
var options = map__45860__$1;
var map__45861 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45860__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__45861__$1 = cljs.core.__destructure_map(map__45861);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45861__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45861__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45861__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45858_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__45858_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
