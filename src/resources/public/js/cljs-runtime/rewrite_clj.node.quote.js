...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k46681,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46681,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__46715){
var vec__46717 = p__46715;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46717,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46717,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46680){
var self__ = this;
var G__46680__$1 = this;
return (new cljs.core.RecordIter((0),G__46680__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46682,other46683){
var self__ = this;
var this46682__$1 = this;
return (((!((other46683 == null)))) && ((((this46682__$1.constructor === other46683.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46682__$1.tag,other46683.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46682__$1.prefix,other46683.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46682__$1.sym,other46683.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46682__$1.children,other46683.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46682__$1.__extmap,other46683.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k46681){
var self__ = this;
var this__5350__auto____$1 = this;
var G__46748 = k46681;
var G__46748__$1 = (((G__46748 instanceof cljs.core.Keyword))?G__46748.fqn:null);
switch (G__46748__$1) {
case "tag":
case "prefix":
case "sym":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k46681);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__46680){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__46749 = cljs.core.keyword_identical_QMARK_;
var expr__46750 = k__5352__auto__;
if(cljs.core.truth_((pred__46749.cljs$core$IFn$_invoke$arity$2 ? pred__46749.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__46750) : pred__46749.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__46750)))){
return (new rewrite_clj.node.quote.QuoteNode(G__46680,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46749.cljs$core$IFn$_invoke$arity$2 ? pred__46749.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__46750) : pred__46749.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__46750)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__46680,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46749.cljs$core$IFn$_invoke$arity$2 ? pred__46749.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__46750) : pred__46749.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__46750)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__46680,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46749.cljs$core$IFn$_invoke$arity$2 ? pred__46749.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__46750) : pred__46749.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__46750)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__46680,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__46680),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__46680){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__46680,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__46687){
var extmap__5385__auto__ = (function (){var G__46766 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46687,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__46687)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46766);
} else {
return G__46766;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__46687),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__46687),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__46687),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__46687),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__46803 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__46803;
continue;
}
break;
...
var G__46804 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__46804;
continue;
}
break;
...
var G__46805 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__46805;
continue;
}
break;
...
var G__46810 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__46810;
continue;
}
break;
