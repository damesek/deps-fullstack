...
var rewrite_clj$node$protocols$Node$tag$dyn_45923 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_45923(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_45929 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_45929(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_45936 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_45936(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_45940 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_45940(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_45949 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_45949(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_45957 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_45957(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45864_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__45864_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_45966 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_45966(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_45975 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_45975(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_45978 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_45978(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_45985 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_45985(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_46021 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_46021(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_46027 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_46027(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_46038 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_46038(node);
}
});
...
var map__45912 = cljs.core.meta(node);
var map__45912__$1 = cljs.core.__destructure_map(map__45912);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45912__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45912__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45912__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45912__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__45913,p__45914){
var vec__45915 = p__45913;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45915,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45915,(1),null);
var vec__45918 = p__45914;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45918,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45918,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__45921 = col_extent;
if((row_extent === (0))){
return (G__45921 + col);
} else {
return G__45921;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__45922 = rewrite_clj.node.protocols.children(node);
var G__45922__$1 = (((G__45922 == null))?null:cljs.core.first(G__45922));
if((G__45922__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__45922__$1);
}
} else {
