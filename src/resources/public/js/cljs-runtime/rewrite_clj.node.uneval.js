...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k46839,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46839,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__46849){
var vec__46850 = p__46849;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46850,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46850,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46838){
var self__ = this;
var G__46838__$1 = this;
return (new cljs.core.RecordIter((0),G__46838__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46840,other46841){
var self__ = this;
var this46840__$1 = this;
return (((!((other46841 == null)))) && ((((this46840__$1.constructor === other46841.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46840__$1.children,other46841.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46840__$1.__extmap,other46841.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k46839){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k46839);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__46838){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__46862 = cljs.core.keyword_identical_QMARK_;
var expr__46863 = k__5352__auto__;
if(cljs.core.truth_((pred__46862.cljs$core$IFn$_invoke$arity$2 ? pred__46862.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__46863) : pred__46862.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__46863)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__46838,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__46838),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__46838){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__46838,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__46845){
var extmap__5385__auto__ = (function (){var G__46870 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46845,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__46845)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46870);
} else {
return G__46870;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__46845),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__46907 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__46907;
continue;
}
break;
