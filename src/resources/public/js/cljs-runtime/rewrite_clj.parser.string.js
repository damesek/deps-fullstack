...
if((c === "\n")){
var G__46959 = escape_QMARK_;
var G__46960 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__46959;
lines = G__46960;
continue;
} else {
buf.append(c);

var G__46961 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__46962 = lines;
escape_QMARK_ = G__46961;
lines = G__46962;
continue;
