...
return [(function (){var pred__43506 = cljs.core.instance_QMARK_;
var expr__43507 = reactive_val;
if(cljs.core.truth_((pred__43506.cljs$core$IFn$_invoke$arity$2 ? pred__43506.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__43507) : pred__43506.call(null,reagent.ratom.RAtom,expr__43507)))){
return "ra";
} else {
if(cljs.core.truth_((pred__43506.cljs$core$IFn$_invoke$arity$2 ? pred__43506.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__43507) : pred__43506.call(null,reagent.ratom.RCursor,expr__43507)))){
return "rc";
} else {
if(cljs.core.truth_((pred__43506.cljs$core$IFn$_invoke$arity$2 ? pred__43506.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__43507) : pred__43506.call(null,reagent.ratom.Reaction,expr__43507)))){
return "rx";
} else {
if(cljs.core.truth_((pred__43506.cljs$core$IFn$_invoke$arity$2 ? pred__43506.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__43507) : pred__43506.call(null,reagent.ratom.Track,expr__43507)))){
return "tr";
} else {
return "other";
}
