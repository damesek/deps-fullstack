...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k46693,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46693,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__46724){
var vec__46725 = p__46724;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46725,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46725,(1),null);
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46692){
var self__ = this;
var G__46692__$1 = this;
return (new cljs.core.RecordIter((0),G__46692__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"lines","lines",-700165781)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46694,other46695){
var self__ = this;
var this46694__$1 = this;
return (((!((other46695 == null)))) && ((((this46694__$1.constructor === other46695.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46694__$1.lines,other46695.lines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46694__$1.__extmap,other46695.__extmap)))))));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k46693){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k46693);

}
}));

(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__46692){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__46744 = cljs.core.keyword_identical_QMARK_;
var expr__46745 = k__5352__auto__;
if(cljs.core.truth_((pred__46744.cljs$core$IFn$_invoke$arity$2 ? pred__46744.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"lines","lines",-700165781),expr__46745) : pred__46744.call(null,new cljs.core.Keyword(null,"lines","lines",-700165781),expr__46745)))){
return (new rewrite_clj.node.stringz.StringNode(G__46692,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.stringz.StringNode(self__.lines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__46692),null));
}
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__46692){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.stringz.StringNode(self__.lines,G__46692,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.stringz.map__GT_StringNode = (function rewrite_clj$node$stringz$map__GT_StringNode(G__46697){
var extmap__5385__auto__ = (function (){var G__46763 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46697,new cljs.core.Keyword(null,"lines","lines",-700165781));
if(cljs.core.record_QMARK_(G__46697)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46763);
} else {
return G__46763;
}
})();
return (new rewrite_clj.node.stringz.StringNode(new cljs.core.Keyword(null,"lines","lines",-700165781).cljs$core$IFn$_invoke$arity$1(G__46697),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
