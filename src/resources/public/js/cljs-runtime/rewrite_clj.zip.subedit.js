...
var root = rewrite_clj.zip.base.edn_STAR_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.custom_zipper.core.root(zloc),rewrite_clj.zip.options.get_opts(zloc));
...
var zloc_SINGLEQUOTE_ = (function (){var G__48472 = zloc;
var G__48472__$1 = (((G__48472 == null))?null:rewrite_clj.custom_zipper.core.node(G__48472));
if((G__48472__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.edn_STAR_.cljs$core$IFn$_invoke$arity$2(G__48472__$1,rewrite_clj.zip.options.get_opts(zloc));
}
})();
...
var zloc_SINGLEQUOTE_ = (function (){var G__48473 = rewrite_clj.zip.subedit.subzip(zloc);
