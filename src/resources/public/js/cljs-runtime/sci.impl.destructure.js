...
var G__51250 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__51251 = n;
var G__51252 = cljs.core.nnext(bs);
var G__51253 = true;
ret = G__51250;
n = G__51251;
bs = G__51252;
seen_rest_QMARK_ = G__51253;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__51205_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__51205_SHARP_);
}
})(),cljs.core.name(p1__51205_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__51206_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__51206_SHARP_);
}
})(),cljs.core.name(p1__51206_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__51207_SHARP_,p2__51208_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__51207_SHARP_,p2__51208_SHARP_,(function (){var fexpr__51237 = cljs.core.val(entry);
return (fexpr__51237.cljs$core$IFn$_invoke$arity$1 ? fexpr__51237.cljs$core$IFn$_invoke$arity$1(p2__51208_SHARP_) : fexpr__51237.call(null,p2__51208_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__51238 = cljs.core.key(entry);
return (fexpr__51238.cljs$core$IFn$_invoke$arity$1 ? fexpr__51238.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__51238.call(null,bes));
})());
...
var bv = (function (){var temp__5802__auto__ = cljs.core.find(defaults,local);
...
var G__51266 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__51267 = cljs.core.next(bes);
ret = G__51266;
bes = G__51267;
continue;
} else {
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51213_SHARP_){
return (cljs.core.first(p1__51213_SHARP_) instanceof cljs.core.Keyword);
}),bents));
