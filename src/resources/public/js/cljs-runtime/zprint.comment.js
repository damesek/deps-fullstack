...
var G__50053 = (cljs.core.truth_(next_lf)?cljs.core.subs.cljs$core$IFn$_invoke$arity$2(input,(next_lf + (1))):null);
var G__50054 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,chunk);
input = G__50053;
out = G__50054;
continue;
}
...
var G__50061 = moving_up;
var G__50062 = (total_up + up_size);
ploc = G__50061;
total_up = G__50062;
continue;
}
...
var vec__49824 = zprint.comment.left_or_up(zloc);
var up_size = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49824,(0),null);
var next_zloc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49824,(1),null);
var ploc = next_zloc;
...
var vec__49834 = zprint.comment.left_or_up(ploc);
var up_size__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49834,(0),null);
var next_zloc__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49834,(1),null);
if(cljs.core.truth_(length_right_of_newline)){
return (length_right_of_newline + indent_before);
} else {
var G__50070 = next_zloc__$1;
var G__50071 = ((indent_before + cljs.core.count(zstr)) + up_size__$1);
ploc = G__50070;
indent_before = G__50071;
continue;
}
}
break;
...
while(true){
var vec__49857 = (function (){var tnloc = (zprint.zfns.ztag.cljs$core$IFn$_invoke$arity$1 ? zprint.zfns.ztag.cljs$core$IFn$_invoke$arity$1(nloc) : zprint.zfns.ztag.call(null,nloc));
...
var tnloc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49857,(0),null);
var spaces__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49857,(1),null);
if((tnloc == null)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tnloc,new cljs.core.Keyword(null,"newline","newline",1790071323))){
var G__50075 = rewrite_clj.zip.left_STAR_(nloc);
var G__50076 = spaces__$1;
var G__50077 = true;
nloc = G__50075;
spaces = G__50076;
passed_nl_QMARK_ = G__50077;
continue;
} else {
...
var G__50082 = rewrite_clj.zip.left_STAR_(nloc);
var G__50083 = (rewrite_clj.zip.length(nloc) + spaces__$1);
var G__50084 = passed_nl_QMARK_;
nloc = G__50082;
spaces = G__50083;
passed_nl_QMARK_ = G__50084;
continue;
...
var seq_after_space = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__49865_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49865_SHARP_," ");
}),rev_seq);
...
var seq_after_space = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__49866_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49866_SHARP_," ");
 ...
 */
zprint.comment.wrap_comment = (function zprint$comment$wrap_comment(width,p__49873,start){
var vec__49874 = p__49873;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49874,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49874,(1),null);
var stype = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49874,(2),null);
var element = vec__49874;
 ...
 */
zprint.comment.loc_vec = (function zprint$comment$loc_vec(start,p__49887){
...
var G__50264 = cljs.core.next(element_vec);
var G__50265 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(element_vec));
element_vec = G__50264;
out = G__50265;
continue;
}
break;
 ...
 */
zprint.comment.fzprint_wrap_comments = (function zprint$comment$fzprint_wrap_comments(p__49895,style_vec){
var map__49897 = p__49895;
var map__49897__$1 = cljs.core.__destructure_map(map__49897);
var options = map__49897__$1;
...
var vec__49907 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,index);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49907,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49907,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49907,(2),null);
...
var indent_index = zprint.comment.find_element_from_end((function (p1__49913_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__49913_SHARP_,new cljs.core.Keyword(null,"indent","indent",-148200125))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__49913_SHARP_,new cljs.core.Keyword(null,"newline","newline",1790071323))));
}),style_vec);
 ...
 */
zprint.comment.fzprint_inline_comments = (function zprint$comment$fzprint_inline_comments(p__49919,style_vec){
var map__49920 = p__49919;
var map__49920__$1 = cljs.core.__destructure_map(map__49920);
var options = map__49920__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49920__$1,new cljs.core.Keyword(null,"width","width",-384071477));
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(options))){
...
var vec__49937 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49937,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49937,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49937,(2),null);
var element = vec__49937;
var vec__49940 = cljs.core.second(cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49940,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49940,(1),null);
var ne = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49940,(2),null);
var nn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49940,(3),null);
var next_element = vec__49940;
var vec__49943 = last_out;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49943,(0),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49943,(1),null);
var le = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49943,(2),null);
...
var G__50274 = cljs.core.next(cvec);
var G__50275 = new_element;
var G__50276 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_element);
cvec = G__50274;
last_out = G__50275;
out = G__50276;
continue;
...
var vec__49968 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49968,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49968,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49968,(2),null);
var spaces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49968,(3),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49968,(4),null);
var element = vec__49968;
...
var G__50278 = cljs.core.next(cvec);
var G__50279 = (index + (1));
var G__50280 = null;
var G__50281 = (cljs.core.truth_(last_indent)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_seq,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)):(function(){throw (new Error(["find-aligned-inline-comments a:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__50282 = current_column;
var G__50283 = (0);
var G__50284 = out;
cvec = G__50278;
index = G__50279;
last_indent = G__50280;
current_seq = G__50281;
current_column = G__50282;
distance = G__50283;
out = G__50284;
continue;
} else {
var G__50285 = cljs.core.next(cvec);
var G__50286 = (index + (1));
var G__50287 = null;
var G__50288 = (cljs.core.truth_(last_indent)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)], null):(function(){throw (new Error(["find-aligned-inline-comments b:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__50289 = start_column;
var G__50290 = (0);
var G__50291 = (((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out);
cvec = G__50285;
index = G__50286;
last_indent = G__50287;
current_seq = G__50288;
current_column = G__50289;
distance = G__50290;
out = G__50291;
continue;
}
...
var G__50292 = cljs.core.next(cvec);
var G__50293 = (index + (1));
var G__50294 = index;
var G__50295 = cljs.core.PersistentVector.EMPTY;
var G__50296 = (0);
var G__50297 = (0);
var G__50298 = (((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out);
cvec = G__50292;
index = G__50293;
last_indent = G__50294;
current_seq = G__50295;
current_column = G__50296;
distance = G__50297;
out = G__50298;
continue;
} else {
var G__50299 = cljs.core.next(cvec);
var G__50300 = (index + (1));
var G__50301 = index;
var G__50302 = current_seq;
var G__50303 = current_column;
var G__50304 = (distance + (1));
var G__50305 = out;
cvec = G__50299;
index = G__50300;
last_indent = G__50301;
current_seq = G__50302;
current_column = G__50303;
distance = G__50304;
out = G__50305;
continue;
}
} else {
var G__50307 = cljs.core.next(cvec);
var G__50308 = (index + (1));
var G__50309 = last_indent;
var G__50310 = current_seq;
var G__50311 = current_column;
var G__50312 = distance;
var G__50313 = out;
cvec = G__50307;
index = G__50308;
last_indent = G__50309;
current_seq = G__50310;
current_column = G__50311;
distance = G__50312;
out = G__50313;
continue;
...
var vec__49985 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(2),null);
var element = vec__49985;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"comment-inline","comment-inline",712944405))){
var G__50314 = cljs.core.next(cvec);
var G__50315 = (index + (1));
var G__50316 = null;
var G__50317 = (cljs.core.truth_(last_indent)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_seq,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)):(function(){throw (new Error(["find-consecutive-inline-comments:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__50318 = out;
cvec = G__50314;
index = G__50315;
last_indent = G__50316;
current_seq = G__50317;
out = G__50318;
continue;
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"indent","indent",-148200125))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"newline","newline",1790071323))))){
var G__50319 = cljs.core.next(cvec);
var G__50320 = (index + (1));
var G__50321 = index;
var G__50322 = (cljs.core.truth_(last_indent)?cljs.core.PersistentVector.EMPTY:current_seq);
var G__50323 = (cljs.core.truth_(last_indent)?(((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out):out);
cvec = G__50319;
index = G__50320;
last_indent = G__50321;
current_seq = G__50322;
out = G__50323;
continue;
} else {
var G__50324 = cljs.core.next(cvec);
var G__50325 = (index + (1));
var G__50326 = last_indent;
var G__50327 = current_seq;
var G__50328 = out;
cvec = G__50324;
index = G__50325;
last_indent = G__50326;
current_seq = G__50327;
out = G__50328;
continue;
 ...
 */
zprint.comment.comment_column = (function zprint$comment$comment_column(p__49993,style_vec){
var vec__49994 = p__49993;
var indent_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49994,(0),null);
var comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49994,(1),null);
...
var G__50330 = (index + (1));
var G__50331 = zprint.comment.loc_vec(column,cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,index));
index = G__50330;
column = G__50331;
continue;
}
 ...
 */
zprint.comment.comment_vec_column = (function zprint$comment$comment_vec_column(style_vec,p__50001){
var vec__50002 = p__50001;
var indent_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50002,(0),null);
var inline_comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50002,(1),null);
var comment_vec = vec__50002;
...
var minimum_vec = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50007_SHARP_){
return ((cljs.core.second(p1__50007_SHARP_) - cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__50007_SHARP_,(2))) + (1));
}),comment_vec);
 ...
 *   at a new column.
 */
zprint.comment.change_start_column = (function zprint$comment$change_start_column(new_start_column,style_vec,p__50019){
var vec__50021 = p__50019;
var inline_comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50021,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50021,(1),null);
var spaces_before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50021,(2),null);
var comment_vec = vec__50021;
...
var vec__50024 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,previous_element_index);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50024,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50024,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50024,(2),null);
var previous_element = vec__50024;
