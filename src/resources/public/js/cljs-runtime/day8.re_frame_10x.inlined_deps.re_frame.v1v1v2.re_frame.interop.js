...
return [(function (){var pred__40160 = cljs.core.instance_QMARK_;
var expr__40161 = reactive_val;
if(cljs.core.truth_((pred__40160.cljs$core$IFn$_invoke$arity$2 ? pred__40160.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__40161) : pred__40160.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__40161)))){
return "ra";
} else {
if(cljs.core.truth_((pred__40160.cljs$core$IFn$_invoke$arity$2 ? pred__40160.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__40161) : pred__40160.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__40161)))){
return "rc";
} else {
if(cljs.core.truth_((pred__40160.cljs$core$IFn$_invoke$arity$2 ? pred__40160.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__40161) : pred__40160.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__40161)))){
return "rx";
} else {
if(cljs.core.truth_((pred__40160.cljs$core$IFn$_invoke$arity$2 ? pred__40160.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__40161) : pred__40160.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__40161)))){
return "tr";
} else {
return "other";
}
