...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__47004 = cljs.core.get_global_hierarchy;
return (fexpr__47004.cljs$core$IFn$_invoke$arity$0 ? fexpr__47004.cljs$core$IFn$_invoke$arity$0() : fexpr__47004.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__47005_SHARP_){
var _STAR_delimiter_STAR__orig_val__47007 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__47008 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__47008);

try{return rewrite_clj.parser.core.parse_next(p1__47005_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__47007);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___47076 = arguments.length;
var i__5770__auto___47077 = (0);
while(true){
if((i__5770__auto___47077 < len__5769__auto___47076)){
args__5775__auto__.push((arguments[i__5770__auto___47077]));

var G__47078 = (i__5770__auto___47077 + (1));
i__5770__auto___47077 = G__47078;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__47015){
var vec__47016 = p__47015;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47016,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq47010){
var G__47011 = cljs.core.first(seq47010);
var seq47010__$1 = cljs.core.next(seq47010);
var G__47012 = cljs.core.first(seq47010__$1);
var seq47010__$2 = cljs.core.next(seq47010__$1);
var G__47013 = cljs.core.first(seq47010__$2);
var seq47010__$3 = cljs.core.next(seq47010__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47011,G__47012,G__47013,seq47010__$3);
}));
...
var G__47040 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__47040)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__47040)){
...
return cljs.core.cons((function (){var G__47052 = rewrite_clj.reader.peek(reader);
switch (G__47052) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__47040)){
