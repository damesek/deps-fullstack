 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__42407,right){
var map__42409 = p__42407;
var map__42409__$1 = cljs.core.__destructure_map(map__42409);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42409__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42409__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__42419 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42419,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42419,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42419,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42438__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42440 = u(y);
var map__42440__$1 = cljs.core.__destructure_map(map__42440);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42440__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__42503__delegate = function (x,y,more){
...
var G__42503 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42504__i = 0, G__42504__a = new Array(arguments.length -  2);
while (G__42504__i < G__42504__a.length) {G__42504__a[G__42504__i] = arguments[G__42504__i + 2]; ++G__42504__i;}
  more = new cljs.core.IndexedSeq(G__42504__a,0,null);
} 
return G__42503__delegate.call(this,x,y,more);};
G__42503.cljs$lang$maxFixedArity = 2;
G__42503.cljs$lang$applyTo = (function (arglist__42505){
var x = cljs.core.first(arglist__42505);
arglist__42505 = cljs.core.next(arglist__42505);
var y = cljs.core.first(arglist__42505);
var more = cljs.core.rest(arglist__42505);
return G__42503__delegate(x,y,more);
});
...
var G__42507 = null;
if (arguments.length > 2) {
var G__42508__i = 0, G__42508__a = new Array(arguments.length -  2);
while (G__42508__i < G__42508__a.length) {G__42508__a[G__42508__i] = arguments[G__42508__i + 2]; ++G__42508__i;}
G__42507 = new cljs.core.IndexedSeq(G__42508__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42507);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42448__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42449 = u(y);
var map__42449__$1 = cljs.core.__destructure_map(map__42449);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42449__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__42511__delegate = function (x,y,more){
...
var G__42511 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42513__i = 0, G__42513__a = new Array(arguments.length -  2);
while (G__42513__i < G__42513__a.length) {G__42513__a[G__42513__i] = arguments[G__42513__i + 2]; ++G__42513__i;}
  more = new cljs.core.IndexedSeq(G__42513__a,0,null);
} 
return G__42511__delegate.call(this,x,y,more);};
G__42511.cljs$lang$maxFixedArity = 2;
G__42511.cljs$lang$applyTo = (function (arglist__42515){
var x = cljs.core.first(arglist__42515);
arglist__42515 = cljs.core.next(arglist__42515);
var y = cljs.core.first(arglist__42515);
var more = cljs.core.rest(arglist__42515);
return G__42511__delegate(x,y,more);
});
...
var G__42516 = null;
if (arguments.length > 2) {
var G__42517__i = 0, G__42517__a = new Array(arguments.length -  2);
while (G__42517__i < G__42517__a.length) {G__42517__a[G__42517__i] = arguments[G__42517__i + 2]; ++G__42517__i;}
G__42516 = new cljs.core.IndexedSeq(G__42517__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42516);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42460__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42461 = u(y);
var map__42461__$1 = cljs.core.__destructure_map(map__42461);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42461__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__42519__delegate = function (x,y,more){
...
var G__42519 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42520__i = 0, G__42520__a = new Array(arguments.length -  2);
while (G__42520__i < G__42520__a.length) {G__42520__a[G__42520__i] = arguments[G__42520__i + 2]; ++G__42520__i;}
  more = new cljs.core.IndexedSeq(G__42520__a,0,null);
} 
return G__42519__delegate.call(this,x,y,more);};
G__42519.cljs$lang$maxFixedArity = 2;
G__42519.cljs$lang$applyTo = (function (arglist__42521){
var x = cljs.core.first(arglist__42521);
arglist__42521 = cljs.core.next(arglist__42521);
var y = cljs.core.first(arglist__42521);
var more = cljs.core.rest(arglist__42521);
return G__42519__delegate(x,y,more);
});
G__42519.cljs$core$IFn$_invoke$arity$variadic = G__42519__delegate;
return G__42519;
})()
;
...
var G__42522 = null;
if (arguments.length > 2) {
var G__42523__i = 0, G__42523__a = new Array(arguments.length -  2);
while (G__42523__i < G__42523__a.length) {G__42523__a[G__42523__i] = arguments[G__42523__i + 2]; ++G__42523__i;}
G__42522 = new cljs.core.IndexedSeq(G__42523__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42522);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42471__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42472 = u(y);
var map__42472__$1 = cljs.core.__destructure_map(map__42472);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42472__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__42526__delegate = function (x,y,more){
...
var G__42526 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42528__i = 0, G__42528__a = new Array(arguments.length -  2);
while (G__42528__i < G__42528__a.length) {G__42528__a[G__42528__i] = arguments[G__42528__i + 2]; ++G__42528__i;}
  more = new cljs.core.IndexedSeq(G__42528__a,0,null);
} 
return G__42526__delegate.call(this,x,y,more);};
G__42526.cljs$lang$maxFixedArity = 2;
G__42526.cljs$lang$applyTo = (function (arglist__42529){
var x = cljs.core.first(arglist__42529);
arglist__42529 = cljs.core.next(arglist__42529);
var y = cljs.core.first(arglist__42529);
var more = cljs.core.rest(arglist__42529);
return G__42526__delegate(x,y,more);
});
...
var G__42532 = null;
if (arguments.length > 2) {
var G__42533__i = 0, G__42533__a = new Array(arguments.length -  2);
while (G__42533__i < G__42533__a.length) {G__42533__a[G__42533__i] = arguments[G__42533__i + 2]; ++G__42533__i;}
G__42532 = new cljs.core.IndexedSeq(G__42533__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42532);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
