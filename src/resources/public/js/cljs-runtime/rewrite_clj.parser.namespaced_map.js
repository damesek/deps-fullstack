...
var G__46921 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,n);
nodes = G__46921;
continue;
} else {
...
var vec__46913 = rewrite_clj.parser.namespaced_map.parse_to_next_elem(reader,read_next);
var whitespace_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46913,(0),null);
var map_node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46913,(1),null);
