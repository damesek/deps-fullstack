...
var G__36897 = devtools.prefs.pref(v);
v = G__36897;
continue;
} else {
return v;
...
}catch (e36856){var _e__36146__auto__ = e36856;
return false;
}})();
...
}catch (e36862){var _e__36146__auto__ = e36862;
return false;
}})();
...
}catch (e36870){var _e__36146__auto__ = e36870;
return false;
}}
}
});
...
var vec__36886 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36886,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36886,(1),null);
...
return cljs.core.some((function (p1__36890_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__36890_SHARP_);
}),template);
});
