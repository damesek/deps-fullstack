...
var G__43369 = o;
reagent.impl.template.goog$module$goog$object.set(G__43369,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43396__delegate = function (args){
...
while (G__43397__i < G__43397__a.length) {G__43397__a[G__43397__i] = arguments[G__43397__i + 0]; ++G__43397__i;}
  args = new cljs.core.IndexedSeq(G__43397__a,0,null);
} 
...
var args = cljs.core.seq(arglist__43398);
...
var G__43370 = o;
reagent.impl.template.goog$module$goog$object.set(G__43370,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43401__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__43403__i < G__43403__a.length) {G__43403__a[G__43403__i] = arguments[G__43403__i + 0]; ++G__43403__i;}
  args = new cljs.core.IndexedSeq(G__43403__a,0,null);
} 
return G__43401__delegate.call(this,args);};
G__43401.cljs$lang$maxFixedArity = 0;
G__43401.cljs$lang$applyTo = (function (arglist__43404){
var args = cljs.core.seq(arglist__43404);
return G__43401__delegate(args);
});
...
var G__43371 = props;
var G__43371__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43371,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43371);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43371__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43372 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43372,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43372;
}
})(),id_class);
...
var G__43373 = (cljs.core.count(argv) - first_child);
switch (G__43373) {
case (0):
...
var vec__43374 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43374,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43374,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43374,(2),null);
...
var temp__5808__auto___43414 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___43414 == null)){
} else {
var key_43415 = temp__5808__auto___43414;
(jsprops.key = key_43415);
}
...
var temp__5808__auto___43418 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___43418 == null)){
} else {
var key_43421 = temp__5808__auto___43418;
(jsprops.key = key_43421);
}
...
var temp__5808__auto___43422 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___43422 == null)){
} else {
var key_43423 = temp__5808__auto___43422;
(jsprops.key = key_43423);
}
...
var temp__5808__auto___43430 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___43430 == null)){
} else {
var key_43431 = temp__5808__auto___43430;
(jsprops.key = key_43431);
}
...
var temp__5808__auto___43432 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___43432 == null)){
} else {
var key_43433 = temp__5808__auto___43432;
(jsprops.key = key_43433);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43377_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43377_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43378 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43378,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43378,(1),null);
...
break;
default:
var G__43435 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43436 = compiler;
v = G__43435;
compiler = G__43436;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template43388 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template43388 = (function (opts,id,fn_to_element,meta43389){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta43389 = meta43389;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template43388.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43390,meta43389__$1){
var self__ = this;
var _43390__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43388(self__.opts,self__.id,self__.fn_to_element,meta43389__$1));
}));

(reagent.impl.template.t_reagent$impl$template43388.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43390){
var self__ = this;
var _43390__$1 = this;
return self__.meta43389;
}));

(reagent.impl.template.t_reagent$impl$template43388.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43388.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43388.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43388.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43388.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta43389","meta43389",458718323,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43388.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43388.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43388");

(reagent.impl.template.t_reagent$impl$template43388.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template43388");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43388.
 */
reagent.impl.template.__GT_t_reagent$impl$template43388 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template43388(opts__$1,id__$1,fn_to_element__$1,meta43389){
return (new reagent.impl.template.t_reagent$impl$template43388(opts__$1,id__$1,fn_to_element__$1,meta43389));
});

}

return (new reagent.impl.template.t_reagent$impl$template43388(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
