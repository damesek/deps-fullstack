...
rewrite_clj.node.keyword.keyword_sexpr = (function rewrite_clj$node$keyword$keyword_sexpr(kw,kw_auto_resolved_QMARK_,map_qualifier,p__46015){
var map__46016 = p__46015;
var map__46016__$1 = cljs.core.__destructure_map(map__46016);
var auto_resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46016__$1,new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983));
...
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var G__46017 = (cljs.core.truth_(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(q))?(function (){var G__46019 = (function (){var or__5045__auto__ = (function (){var G__46020 = new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q);
if((G__46020 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__46020);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
var fexpr__46018 = (function (){var or__5045__auto__ = auto_resolve;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46017);
}
})(),cljs.core.name(kw));
});
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k46024,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__46042 = k46024;
var G__46042__$1 = (((G__46042 instanceof cljs.core.Keyword))?G__46042.fqn:null);
switch (G__46042__$1) {
case "k":
return self__.k;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46024,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__46044){
var vec__46045 = p__46044;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46045,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46045,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46023){
var self__ = this;
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46025,other46026){
var self__ = this;
var this46025__$1 = this;
return (((!((other46026 == null)))) && ((((this46025__$1.constructor === other46026.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46025__$1.k,other46026.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46025__$1.auto_resolved_QMARK_,other46026.auto_resolved_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46025__$1.map_qualifier,other46026.map_qualifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46025__$1.__extmap,other46026.__extmap)))))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k46024){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k46024);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__46023){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__46097 = cljs.core.keyword_identical_QMARK_;
var expr__46098 = k__5352__auto__;
if(cljs.core.truth_((pred__46097.cljs$core$IFn$_invoke$arity$2 ? pred__46097.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__46098) : pred__46097.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__46098)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__46023,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46097.cljs$core$IFn$_invoke$arity$2 ? pred__46097.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__46098) : pred__46097.call(null,new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__46098)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__46023,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46097.cljs$core$IFn$_invoke$arity$2 ? pred__46097.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__46098) : pred__46097.call(null,new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__46098)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,G__46023,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__46023),null));
}
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__46023){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,G__46023,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__46029){
var extmap__5385__auto__ = (function (){var G__46111 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46029,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720)], 0));
if(cljs.core.record_QMARK_(G__46029)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46111);
} else {
return G__46111;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__46029),new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(G__46029),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720).cljs$core$IFn$_invoke$arity$1(G__46029),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
