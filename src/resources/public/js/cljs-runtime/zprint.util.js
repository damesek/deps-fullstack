...
var sq_dev_from_mean = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49430_SHARP_){
return (p1__49430_SHARP_ * p1__49430_SHARP_);
}),dev_from_mean);
...
var indicies = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__49435,n){
var vec__49436 = p__49435;
var max_so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49436,(0),null);
var indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49436,(1),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49436,(2),null);
if((n == null)){
...
var vec__49441 = zprint.util.find_max(coll_vec);
var max_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49441,(0),null);
var indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49441,(1),null);
var length = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49441,(2),null);
...
var vec__49446 = cljs.core.split_at(index,columns);
var beginning = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49446,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49446,(1),null);
...
if((row_count > (2))){
var vec__49454 = zprint.util.remove_max_not_half(column);
var first_indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49454,(0),null);
var first_column_wo_max = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49454,(1),null);
...
var vec__49459 = zprint.util.remove_max_not_half(first_column_wo_max);
var second_indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49459,(0),null);
var second_column_wo_max = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49459,(1),null);
...
var G__49521 = cljs.core.next(coll__$1);
var G__49522 = (index + (1));
var G__49523 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,(((index >= last_good_col))?null:zprint.util.size.cljs$core$IFn$_invoke$arity$2(cljs.core.first(coll__$1),no_string_adj_QMARK_)));
coll__$1 = G__49521;
index = G__49522;
out = G__49523;
continue;
...
var max_width_vec = cljs.core.second(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__49497,index){
var vec__49498 = p__49497;
var columns__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49498,(0),null);
var max_width_vec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49498,(1),null);
var vec__49501 = zprint.util.column_width_variance(max_variance,columns__$1,index);
var max_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49501,(0),null);
var new_columns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49501,(1),null);
...
return cljs.core.second(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__49507,column_max_width){
var vec__49509 = p__49507;
var current_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49509,(0),null);
var cumulative_widths = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49509,(1),null);
